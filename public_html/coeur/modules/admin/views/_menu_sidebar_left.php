<nav id="sidebar-left" class="sidebar mcs-overflow">
                ...
                <div class="nav-menu-wrapper mcs-overflow1">
                	<ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="#" data-dp-action="submenu-toggle"><i class="zmdi zmdi-border-color"></i>&nbsp;<span>Souscription</span></a>
                            <ul>
                                <li><a href="<?php echo base_url() ?>index.php/admin/souscription">souscription</a></li>
                               
                                
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="#" data-dp-action="submenu-toggle"><i class="zmdi zmdi-chart"></i>&nbsp;<span>Valider souscriptions</span></a>
                            <ul>
                                <li><a href="<?php echo base_url() ?>index.php/admin/attente_de_validation_souscription">Validation des souscriptions</a></li>
                               
                                
                            </ul>
                        </li>
                        <li class="nav-item mm-col-3">
                            <a href="#" data-dp-action="submenu-toggle" class="mega-menu-toggle"><i class="zmdi zmdi-laptop-mac"></i>&nbsp;<span>Liste des validations</span></a>
                            <ul class="mega-menu">
                                <li>
                                    <ul>
